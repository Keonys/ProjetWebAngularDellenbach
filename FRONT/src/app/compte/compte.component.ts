...
export class CompteComponent implements OnInit {
  ...
  constructor(private formBuilder : FormBuilder, private _httpClient:HttpClient, private apiservice: ApiService) { }
  ...
  saveUser() {
    if(this.verifPassword()){
      ...
      if(this.compteForm.valid){
        ...
        this.apiservice.postClient(this.user).subscribe(res =>{
          console.log(res);
        });
      }
    }else{
